...
::
    ...
    将当前仓库代码提交到fork仓库：git remote add upstream git@github.ibm.com:lanzejun/openshift-poc.git
    git push git@github.ibm.com:lanzejun/openshift-poc.git

Connecting with SSH
========================
https://help.github.com/cn/enterprise/2.16/user/authenticating-to-github/connecting-to-github-with-ssh

* ssh: connect to host github.com port 22: Connection timed out // 解决方法 重启光猫


::

    ssh -T git@github.ibm.com  # 测试链接是否正常
    git config --local -e # 查看本地仓库配置
    cat ~/.gitconfig // Mac
...
::
    ...
    git remote set-url origin https://github.com/murphylan/****.git
...
#. https://help.github.com/cn/enterprise/2.19/user/github
#. Github的使用: https://www.bootcss.com/p/git-guide/